...
import {
    shouldLoadPolyfill as shouldLoadInObPolyfill
} from '#polyfills/stubs/intersection-observer-stub';
import {
    shouldLoadPolyfill as shouldLoadResObPolyfill
...
import {
    MultidocManager
} from './multidoc-manager';
import {
    hasRenderDelayingServices
} from './render-delaying-services';

import {
    cssText as ampDocCss
} from '../build/ampdoc.css';
import {
